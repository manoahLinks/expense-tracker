const ScoreCard = () => {
    return ( 
        <div className="flex justify-evenly m-2 shadow-lg rounded-md ">
            ...
            <div className="flex flex-col items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 fill-blue-900">
                ...
                <h4 className=" text-sm font-semibold">N124,000</h4>
            </div>

            <div className="flex flex-col items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 fill-green-700">
                ...
                <h4 className="text-sm font-semibold">N140,000</h4>
            </div>
