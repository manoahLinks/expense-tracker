        ...
        <div className="flex flex-col m-2 rounded-md shadow-lg">
            <div className="flex justify-between">
                ...
                <div className="">
                    ...
                    <div className="flex items-center">
                        <h4 className="text-sm text-purple-900">9079390551</h4>
            ...
            <div className="flex flex-col items-center p-2">
                ...
                <div className="flex items-center py-3">
                    <h4 className="text-xl font-semibold">N 0.00</h4>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mx-2">
                        <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0112.548-3.364l1.903 1.903h-3.183a.75.75 0 100 1.5h4.992a.75.75 0 00.75-.75V4.356a.75.75 0 00-1.5 0v3.18l-1.9-1.9A9 9 0 003.306 9.67a.75.75 0 101.45.388zm15.408 3.352a.75.75 0 00-.919.53 7.5 7.5 0 01-12.548 3.364l-1.902-1.903h3.183a.75.75 0 000-1.5H2.984a.75.75 0 00-.75.75v4.992a.75.75 0 001.5 0v-3.18l1.9 1.9a9 9 0 0015.059-4.035.75.75 0 00-.53-.918z" clipRule="evenodd" />
                    </svg>
                </div>
                <div className="flex">
                    <button className="px-4 py-2 font-semibold border border-silver-100 rounded-md">withdraw</button>
                    <button className="mx-3 px-8 font-semibold py-2 text-white rounded-md bg-purple-800">Fund</button>
                </div>
            </div>
        </div>
     );
